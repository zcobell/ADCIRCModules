...
class Constants {
 public:
  ...
  /**
   * @brief Returns the equatorial radius of earth in meters
   * @return equatorial radius of earth in meters
   */
  ...
  static double distance(double x1, double y1, double x2, double y2,
                         bool geodesic = false);
  static double distance(const Adcirc::Point &p1, const Adcirc::Point &p2,
                         bool geodesic = false);
  static double distance(const Adcirc::Point &p1, double x2, double y2,
                         bool geodesic = false);
