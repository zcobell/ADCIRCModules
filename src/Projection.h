...
class Projection {
 public:
  ...
  static int ADCIRCMODULES_EXPORT transform(
      int epsgInput, int epsgOutput, const std::vector<Adcirc::Point> &points,
      std::vector<Adcirc::Point> &output, bool &isLatLon);
