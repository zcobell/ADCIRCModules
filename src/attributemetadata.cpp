...
/**
 * @brief Constructor
 * @param[in] name name of nodal attribute
 * @param[in] units units for nodal attribute
 * @param[in] numValues number of values per node
 */
 ...
 * @param[in] name string to use for name
 */
 ...
 * @param[in] units value to set for the units string
 */
 ...
 * @param[in] numValues number of values to resize the object to use
 *
 ...
 * @param[in] index position to return
 ...
 * @param[in] value vector to use to fill the default values vector
 */
 ...
 * @param[in] value value to fill for all default values
 */
 ...
 * @param[in] index position to set the default value
 * @param[in] value value to set at index
 */
