...
class Mesh {
 public:
  ...
  size_t ADCIRCMODULES_EXPORT findNearestNode(Adcirc::Point &location);
  size_t ADCIRCMODULES_EXPORT findNearestNode(double x, double y);
  size_t ADCIRCMODULES_EXPORT findNearestElement(Adcirc::Point &location);
  size_t ADCIRCMODULES_EXPORT findNearestElement(double x, double y);
  size_t ADCIRCMODULES_EXPORT findElement(Adcirc::Point location);
