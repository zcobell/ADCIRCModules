...
f = pyadcircmodules.NodalAttributes("../testing/test_files/ms-riv.13",m)
f.read()
...
o = pyadcircmodules.ReadOutput("../testing/test_files/maxele.63")
o.open();
o.read();
o.close()
...
onc = pyadcircmodules.ReadOutput("../testing/test_files/maxele.63.nc")
onc.open()
onc.read()
onc.close();
print("   Output value for reacord 1 at node 42: ",onc.data(0).z(41))
print("Reading ascii timeseries scalar file")
asc = pyadcircmodules.ReadOutput("../testing/test_files/sparse_fort.63")
asc.open();
asc.read();
asc.read();
asc.read();
...
ncv=pyadcircmodules.ReadOutput("../testing/test_files/fort.64.nc")
ncv.open();
ncv.read();
ncv.read();
...
print("       Direction is: ",ncv.data(2).direction(1220,pyadcircmodules.Radians), "radians or ",ncv.data(2).direction(1220,pyadcircmodules.Degrees)," degrees")
print("Success reading netcdf vector timeseries file")
ncv.close()
print("Reading harmonics elevation file")
he = pyadcircmodules.HarmonicsOutput("../testing/test_files/fort.53");
he.read();
...
hv = pyadcircmodules.HarmonicsOutput("../testing/test_files/fort.54");
hv.read();
